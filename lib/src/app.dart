  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<UserMatchesService>(
            builder: (_) => UserMatchesService()),
        ChangeNotifierProvider<ChampionsService>(
            builder: (_) => ChampionsService()),
        ChangeNotifierProvider<UserMatchesDetailsService>(
            builder: (_) => UserMatchesDetailsService()),
        ChangeNotifierProvider<UserChampionsService>(
            builder: (_) => UserChampionsService()),
      ],
    ...
    return DynamicTheme(
        ...
        themedWidgetBuilder: (context, theme) {
          return new MaterialApp(
            title: 'Lol Profile',
            theme: theme,
            home: userAuth.isLogged != null && userAuth.isLogged
                ? BaseScreen()
                : LoginScreen(),
            routes: {
