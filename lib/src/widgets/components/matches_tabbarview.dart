...
class MatchesTabBarView extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            userMatchesDetails.resultMessage != null &&
                    userMatchesDetails.resultMessage['success'] == false
                ? Text(userMatchesDetails.resultMessage['message'])
                : _isLoading
                    ? CircularProgressIndicator()
                    : _buildMatches(_userMatchesDetails),
          ],
        ),
      ),
    );
  ...
  Widget _buildMatches(List<MatchDetailModel> _userMatchesDetails) {
    return Expanded(
